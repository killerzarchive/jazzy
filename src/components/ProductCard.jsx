...
export default function ProductCard({ product, onSelect, onAddToCart }) {
  ...
  return (
    <div className="flex flex-col group cursor-pointer" onClick={onSelect}>
      ...
      <p className="text-[13px] text-black font-medium leading-snug mb-1">{product.name}</p>
      <div className="flex items-center gap-2">
        <span className="text-[13px] font-bold text-black">${product.price.toFixed(2)}</span>
        {onSale && (
